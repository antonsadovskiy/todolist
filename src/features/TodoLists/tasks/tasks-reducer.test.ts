...
import {addTodolistAC, removeTodolistAC, setTodolistsAC, TodoListDomainType} from "../todolists/todolists-reducer";
...
test('empty array should be added to tasks state', () => {
